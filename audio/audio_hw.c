...
#define PCM_DEVICE 3       /* Playback link */
...
struct audio_device {
    ...
    audio_devices_t active_out_device;
    audio_devices_t active_in_device;
...
struct dev_name_map_t {
    int mask;
    const char *name;
} ;

static const struct dev_name_map_t dev_names[] = {
